...
function ToggleControls.ToggleColor(stack, deps, text, defaultState, defaultColor, callback)
    ...
    local create, addCorner, addStroke = deps.create, deps.addCorner, deps.addStroke
    local openColorPickerInGui = deps.openColorPickerInGui
    ...
    colorBtn.MouseButton1Click:Connect(function()
        local rootGui = colorBtn:FindFirstAncestorOfClass("ScreenGui")
        openColorPickerInGui(rootGui, colorBtn.BackgroundColor3, function(newColor)
...
function ToggleControls.ToggleDualColor(stack, deps, text, defaultState, c1, c2, callback)
    ...
    local function openPicker(btn)
        local rootGui = btn:FindFirstAncestorOfClass("ScreenGui")
        openColorPickerInGui(rootGui, btn.BackgroundColor3, function(newColor)
